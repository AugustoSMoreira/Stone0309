...
namespace Stone0309.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Categoria,Marca,Quantidade,ValorCompra,ValorVenda")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Categoria,Marca,Quantidade,ValorCompra,ValorVenda")] Produto produto)
        {
            if (id != produto.Id)
            {
                return NotFound();
